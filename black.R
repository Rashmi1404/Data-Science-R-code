...
y <- training$Purchase
x <- training%>% select(Age, Gender,City_Category) %>% data.matrix()
...
rsq <- 1 - sse / sst
rsq
# The optimal model has accounted for0.009407109 of the variance in the training data.