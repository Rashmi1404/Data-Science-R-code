...
pc <- read.csv("C:/Users/Rashmi/Desktop/Data Science/ASSIGNMENTS/multilinear/Computer_Data.csv")
...
ggplot(pc) + geom_histogram(aes(trend),binwidth = 0.5 ,fill = "black") + xlab("Trend") #This data is Normally Distributed

ggplot(pc) + geom_histogram(aes(ram),binwidth = 0.9 ,fill = "black") + xlab("ram")
