...
#I am Going to extract the reviews of "F.R.I.E.N.D.S" from IMDB
rurl <- "https://www.imdb.com/title/tt0108778/reviews?ref_=tt_urv"
...
write.table(IMDB_reviews, "Friends_IMDB_Reviews.txt", row.names = F) #THIS cretes a file in your device in Documents
