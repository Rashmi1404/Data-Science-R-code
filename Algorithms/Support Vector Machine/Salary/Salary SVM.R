...
salary_train <-  read.csv("C:/Users/Rashmi/Desktop/Data Science/ASSIGNMENTS/Support Vector Machine/SalaryData_Train.csv") #This data is used to train the Model
attach(salary_train)

salary_test <- read.csv("C:/Users/Rashmi/Desktop/Data Science/ASSIGNMENTS/Support Vector Machine/SalaryData_Test.csv") #This data is used to Test the Model
attach(salary_test)
